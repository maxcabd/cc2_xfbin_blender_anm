...
class BrNuccChunkAnm(BrNuccChunk):
    def init_data(self, br: BinaryReader):
        ...
        self.other_coord_count = br.read_uint16()
        ...
        if self.other_coord_count > 0: # Usually 0, we don't know what it does yet
            self.other_coords = br.read_uint32(self.other_coord_count)
