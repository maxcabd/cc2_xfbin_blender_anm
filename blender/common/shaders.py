...
def F00A(self, meshmat, xfbin_mat, matname, mesh, nodegrp = 'F00A'):
	...
	if mat_format == 69:
		mapping.inputs[1].default_value[0] = xfbin_mat.floats[0]
		mapping.inputs[1].default_value[1] = xfbin_mat.floats[1]
		mapping.inputs[3].default_value[0] = xfbin_mat.floats[2]
		mapping.inputs[3].default_value[1] = xfbin_mat.floats[3]
...
def _02_F00A(self, meshmat, xfbin_mat, matname, mesh, nodegrp = '02F00A'):
	...
	if mat_format == 87:
		mapping1.inputs[1].default_value[0] = xfbin_mat.floats[0]
		mapping1.inputs[1].default_value[1] = xfbin_mat.floats[1]
		mapping1.inputs[3].default_value[0] = xfbin_mat.floats[2]
		mapping1.inputs[3].default_value[1] = xfbin_mat.floats[3]

		mapping2.inputs[1].default_value[0] = xfbin_mat.floats[4]
		mapping2.inputs[1].default_value[1] = xfbin_mat.floats[5]
		mapping2.inputs[3].default_value[0] = xfbin_mat.floats[6]
		mapping2.inputs[3].default_value[1] = xfbin_mat.floats[7]

		nodegroup.inputs[4].default_value = xfbin_mat.floats[12]
...
def default_mat(self, meshmat, xfbin_mat, matname, mesh, nodegrp = 'Default'):
	bpy.context.scene.view_settings.view_transform = 'Standard'
